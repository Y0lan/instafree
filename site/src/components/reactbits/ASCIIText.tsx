// Component ported from https://codepen.io/JuanFuentes/pen/eYEeoyE
// via ReactBits (https://reactbits.dev)
...
class AsciiFilter {
  ...
  constructor(renderer: THREE.WebGLRenderer, { fontSize = 12, fontFamily = "'Courier New', monospace", charset = " .'`^\",:;Il!i~+_-?][}{1)(|/tfjrxnuvczXYUJCLQ0OZmwqpdbkhao*#MW&8%B@$", invert = true } = {}) {
...
class CanvAscii {
  ...
  async init() {
    ...
    } catch (_e) { /* font may not be loaded yet */ }
    ...
    <div ref={containerRef} style={{ position: 'absolute', width: '100%', height: '100%' }}>
      <style>{`
        ...
        div > div > pre {
          ...
          position: absolute;
          left: 0; top: 0;
          background-image: linear-gradient(135deg, #10a37f 0%, #4ade80 50%, #10a37f 100%);
